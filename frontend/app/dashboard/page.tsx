                                ...
                                <div className="flex items-center gap-6">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex gap-4 mt-1">
                                            <span className="text-zinc-500 font-mono text-[10px] uppercase">⭐ {repo.stars}</span>
                                            <span className="text-zinc-500 font-mono text-[10px] uppercase">👀 {repo.views}</span>
                                            <span className="text-zinc-500 font-mono text-[10px] uppercase">📥 {repo.clones}</span>
                                        </div>
                                    </div>
                                </div>
